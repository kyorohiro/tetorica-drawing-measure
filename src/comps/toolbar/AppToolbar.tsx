import { Grid3X3, Menu, MousePointerClick, Pin, Ruler } from "lucide-react";
  ...
  return (
    <div className="absolute left-3 top-3 z-[99999] text-white">
      <details className="group">
        ...
        <div className="mt-2 w-60 rounded-xl border border-white/15 bg-slate-950/90 p-3 shadow-2xl backdrop-blur">
